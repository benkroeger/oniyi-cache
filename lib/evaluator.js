...
function Evaluator({ storePrivate, storeNoStore, ignoreNoLastMod, requestValidator = [], responseValidator = [] }) {
  this.storePrivate = storePrivate;
  this.storeNoStore = storeNoStore;
  this.ignoreNoLastMod = ignoreNoLastMod;
  this.requestValidators = requestValidator.concat(validators.requestValidators);
  this.responseValidators = responseValidator.concat(validators.responseValidators);
}
